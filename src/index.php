          ...
          <div class="col-12 col-md-6 position-relative" style="z-index: 2;">
            <div class="hero__content">
              ...
              <div class="hero__action">
                <button data-subject="Рассчитать стоимость работ" data-micromodal-trigger="modal-callback" class="button button--big button-primary">РАСЧИТАТЬ СТОИМОСТЬ РАБОТ</button>
